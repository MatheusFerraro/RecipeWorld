...
namespace worldRecipeMvc.Data.Migrations
{
    ...
    [Migration("20260131225757_AddOwnerToCategoriesAndIngredients")]
    partial class AddOwnerToCategoriesAndIngredients
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("worldRecipeMvc.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("worldRecipeMvc.Models.Ingredient", b =>
                {
                    ...
                    b.Property<string>("IngredientDetails")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
            ...
            modelBuilder.Entity("worldRecipeMvc.Models.RecipeIngredient", b =>
                {
                    b.Property<int?>("RecipeID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("worldRecipeMvc.Data.RecipeWorldUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("worldRecipeMvc.Models.Recipe", b =>
                {
                    b.HasOne("worldRecipeMvc.Models.Category", "Category")
                        .WithMany("Recipes")
            ...
            modelBuilder.Entity("worldRecipeMvc.Models.RecipeIngredient", b =>
                {
                    b.HasOne("worldRecipeMvc.Models.Ingredient", "Ingredient")
